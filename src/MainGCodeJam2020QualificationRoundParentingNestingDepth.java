 ...
 * parenthesis in their nesting. The nesting depth of a position p is the number
 * of pairs of matching parentheses m such that p is included in the nesting of
 * m.
 * 
 ...
 * Sample Cases #1, #2 and #3, respectively, only because they are not of
 * minimum length. In addition, 1)( and )(1 are not valid solutions to Sample
 * Case #4 because they contain unmatched parentheses and the nesting depth is 0
 ...
 *
 */
public class MainGCodeJam2020QualificationRoundParentingNestingDepth {
